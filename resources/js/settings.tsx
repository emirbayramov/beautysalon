...
const Settings:FC = () => {
  ...
  return {
    ...
    <div className="row">
      ...
      <div className="col-6" onClick={()=>setState(State.Masters)}>
        Masters
      </div>
      <div className="col-3">
      </div>
    ...
    <div className="row">
      ...
      <div className="col-6" onClick={()=>setState(State.Services)}>
        Services
      </div>
      <div className="col-3">
      </div>
    ...
    <div className="row">
      ...
      <div className="col-6" onClick={()=>setState(State.Clients)}>
        Clients
      </div>
      <div className="col-3">
      </div>
